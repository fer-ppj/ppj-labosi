...
Slično kao za znakovne konstante, leksička analiza će propustiti neke konstantne znakovne nizove koji nisu ispravni, npr.~nizove \verb|"\"| i \verb|"\x"|.\footnote{Zbog ovog propuštanja neispravnih nizova, pod određenim uvjetima nije moguće koristiti veći broj konstantnih znakovnih nizova u istom retku, ali s tim se nećemo zamarati.}
...
Gramatika se sastoji od tri skupine produkcija: produkcije za izraze, produkcije za naredbenu struktura programa i produkcije za deklaraciju i definiciju varijabli i funkcija.
...
Međutim, ako tijekom rada programa dođe do referenciranja \emph{null} pokazivača, ponašanje programa postaje nedefinirano s aspekta \emph{C} standarda.
...
Simulator procesora FRISC u web-pregledniku dostupan je \href{http://fer-ppj.github.com/FRISCjs/webapp}{ovdje}\footnote{Preciznije rečeno, uneseni program pisan mnemoničkim jezikom procesora FRISC prevodi se mnemoničkim asemblerom u strojne naredbe procesora FRISC. Generirane strojne naredbe pune se u memoriju od adrese \texttt{0} (ako nije drugačije zadano asemblerskom naredbom \texttt{\`{}ORG}) i simulira se rad procesora FRISC. U nastavku upute ćemo zbog jednostavnosti o cijelom ovom postupku govoriti kao o simulatoru.}.
Isti simulator može se pokrenuti i iz naredbenog retka, koristeći \href{http://nodejs.org}{Node.js} platformu.
Uz instaliran Node.js, bit će potrebno u jedan direktorij dohvatiti i datoteke \href{https://dl.dropboxusercontent.com/u/5412078/labosi/friscasm.js}{friscasm.js}, \href{https://dl.dropboxusercontent.com/u/5412078/labosi/friscjs.js}{friscjs.js} i \href{https://dl.dropboxusercontent.com/u/5412078/labosi/main.js}{main.js}.
